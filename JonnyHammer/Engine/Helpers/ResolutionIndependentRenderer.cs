...
namespace JonnyHammer.Engine.Helpers
{
    public class ResolutionIndependentRenderer
    {
        ...
        public ResolutionIndependentRenderer(Core game)
        {
            _game = game;
        ...
        public void ChangeResolution(int realScreenWidth, int realScreenHeight)
        {
            ScreenWidth = realScreenWidth;
            ScreenHeight = realScreenHeight;
            Initialize();

            _game.Camera.RecalculateTransformationMatrices();
        }
